"""chu_chu_19434 URL Configuration
...
admin.site.site_header = "CHU-CHU"
admin.site.site_title = "CHU-CHU Admin Portal"
admin.site.index_title = "CHU-CHU Admin"

# swagger
api_info = openapi.Info(
    title="CHU-CHU API",
    default_version="v1",
    description="API documentation for CHU-CHU App",
)
